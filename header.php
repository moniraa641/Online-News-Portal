						...
						<div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
						    <ul class="navbar-nav">
						    	 <li class="nav-item"><a class="nav-link" href="index.php">Home</a></li>
							      <li class="nav-item"><a class="nav-link" href="pages/politics.php">Politics</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/economic.php">Economic</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/bangladesh.php">Bangladesh</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/international.php">International</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/sports.php">Sports</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/trade.php">Trade</a></li>
								  <li class="nav-item"><a class="nav-link" href="pages/job.php">Job</a></li>   
						    </ul>
						</div>
						<form method="post">
							<!--<div class="search">-->
							...
							<!--<button class="sbtn" name="submit"><i class="fas fa-search"></i></button>-->
						</form>
